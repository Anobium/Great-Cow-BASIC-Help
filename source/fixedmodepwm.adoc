...
----
    ...
    PWMOn(2)            'where the parameter can be any valid CCP/PWM channel, 1, 2, 3, 4 or 5
    'or
    PWMOff(2)
    
    PWMOn(2, PWMModule)            'where the parameter can be any valid PWM channel, 1, 2, 3, 4, 5, 6, 7, 8 or 9
    'or
    PWMOff(2, PWMModule)
