...
{nbsp}{nbsp}{nbsp}{nbsp}{nbsp}{nbsp}{nbsp}{nbsp}{nbsp}{nbsp}{nbsp}{nbsp}{nbsp}{nbsp}ModeStop=2 drawing stops when all the reachable display borders are encountered by both the parabola  branches
