= Great Cow BASIC documentation maintenance
Jacques Nilo
v1.0, 2015-07-06
:imagesdir: ./images
...
Great Cow BASIC documentation is splitted in small `sectioname.adoc` text files which are then merged in a `master.adoc`
one.
