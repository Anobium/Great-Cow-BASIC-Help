...
Each memory location can be used to hold a variable value, either a byte or a word dependent on *[BILL]*.&#160;&#160;&#160;
...
The complexity of using HEF memory is reduced with the automatical handling of these operations.&#160;&#160;&#160;
