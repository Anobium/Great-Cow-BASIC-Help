...
The following example can be used to change the ADMUX only when the selected port is ADC4.
...
This is will change the ADMUX to read the ATTINY85 internal temperature sensor, set the reference voltage to 1v1 and then wait 100 ms.
