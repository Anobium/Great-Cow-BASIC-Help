...
{empty} +
If any of the variables do not exist, the compiler will create a constant mapping to the  name of the first paramter in the list of parameters that does exist.   If none of the variables exist the no constant is created.
