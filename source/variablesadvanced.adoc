...
|Single
|A numeric floating point values that range from -3.4E+38 to +3.4E+38 with up to seven significant digits.
|Storing decimal numbers that could be a negative number

|Double
|A numeric floating point values that range from 	-1.7E+308 to +1.7E+308 with up to 15 significant digits.
|Storing decimal numbers that could be a negative number
