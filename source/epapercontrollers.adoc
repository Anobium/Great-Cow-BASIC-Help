...
This section covers GLCD devices know as e-Papers.
...
To use the e-Paper driver for a specific simply include the following in your user code.This will initialise the driver.
