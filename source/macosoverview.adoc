=== Overview - macOS Great Cow BASIC 
...
This instructions are for Apple macOS only (not Windows).
...
If at any time you encounter an issue and need help, you will find it over at the Great Cow BASIC discussion forums at https://sourceforge.net/p/gcbasic/discussion/
