...
The compiler was created by Hugh Considine when he was 12 years old.&#160;&#160;That was in 2010.&#160;&#160;Hugh came up with the idea as compiler were hard to use, not free and he had some spare time.
...
The concept of Great Cow Graphical Basic is that the icons make it less scary, and since they all share names with the BASIC commands it is then easy to remember what command corresponds to each icon.Great Cow Graphical Basic
Users can then switch to text mode whenever they want to, go backwards and forwards a few times if they want, and finally end up using just the text programming.&#160;&#160;
