...
The software is developed using Sharp Developer v.3.2.1 ( not Visual Studio ).&#160;&#160;

*BUILDING THE programmer editorprogrammer editorPR EXECUTABLE USING THE FBEDIT IDE*
