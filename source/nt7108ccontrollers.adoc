...
The only connectivity option is the 8-bit full port mode where a full data port (for the data) are required between the microcontroller and the GLCD to control the data bus.
...
https://github.com/Anobium/Great-Cow-BASIC-Demonstration-Sources/blob/master/GLCD_Solutions/GLCD_Simple_Demonstration_Solutions/GLCD_Simple_Demonstation_16F1939_for_NT7108C%4032.gcb[Graphic LCD] for
