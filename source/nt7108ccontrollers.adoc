...
----
    ...
    #define GLCD_DB0 PORTA.2 'DB0 to pin 17
    #define GLCD_DB1 PORTC.0 'DB1 to pin 16
    #define GLCD_DB2 PORTC.1 'DB2 to pin 15
    #define GLCD_DB3 PORTC.2 'DB3 to pin 14
    #define GLCD_DB4 PORTB.4 'DB4 to pin 13
    #define GLCD_DB5 PORTB.5 'DB5 to pin 12
    #define GLCD_DB6 PORTB.6 'DB6 to pin 11
    #define GLCD_DB7 PORTB.7 'DB7 to pin 10
    ;End of define as 8 port,bit(s)
    #define GLCD_CS1 PORTC.7 'CS1 to pin 9
    #define GLCD_CS2 PORTC.6 'CS2 to pin 8
    #define GLCD_RESET PORTC.3 'RST to pin 7
    #define GLCD_RW PORTC.4   'RW to pin 6
    #define GLCD_RS PORTC.5  'RS to pin 5
    #define GLCD_ENABLE PORTA.4 'Enable to pin 3
