= Great Cow BASIC documentation Howto
Jacques Nilo
v1.1, 2015-07-12
:imagesdir: ./images
...
Great Cow BASIC documentation is maintained through http://asciidoctor.org/[asciidoctor] a fast text processor
...
The main advantages of using asciidoctor to maintain Great Cow BASIC documentation are:
...
Great Cow BASIC documentation is splitted in small `sectioname.adoc` text files which are then merged in a `gcbasic.adoc`
one.
...
call java com.icl.saxon.StyleSheet ..\..\source\%1.xml %GCBstyleHTML% ^
 ...
 htmlhelp.chm="%1.chm"  htmlhelp.title="Great Cow BASIC Help" generate.toc=" " use.id.as.filename=1
if ERRORLEVEL 1 goto :ERROR
call hhc %1.hhp
del *.htm*
del *.hh*
